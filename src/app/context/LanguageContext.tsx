...
const translations: Translations = {
  en: {
    ...
    'schedule.departure.description': 'Hop aboard the bus departing from Plaza de Legazpi!',
    'schedule.guest.reception': 'Guest Reception',
    'schedule.guest.reception.location': 'Reception Area',
    'schedule.guest.reception.description': 'We await you at La Cúpula of the Finca Miravalle.',
    'schedule.ceremony': 'Ceremony',
    'schedule.ceremony.location': 'Ceremony Venue',
    'schedule.ceremony.description': 'Be a witness to our "I do\'s".',
    ...
    'schedule.banquet.description': 'Time to feast and eat to your heart\'s content!',
    ...
    'rsvp.transport.bus': 'Party bus, please! Save me a spot.',
  ...
  es: {
    ...
    'schedule.departure.description': '¡Sube al autocar que sale desde la plaza de Legazpi!',
    'schedule.guest.reception': 'Recepción de Invitados',
    'schedule.guest.reception.location': 'Área de Recepción',
    'schedule.guest.reception.description': 'Te esperamos en La Cúpula de la Finca Miravalle.',
    'schedule.ceremony': 'Ceremonia',
    'schedule.ceremony.location': 'Lugar de la Ceremonia',
    'schedule.ceremony.description': 'Sé testigo de nuestros "Sí, quiero".',
    ...
    'schedule.banquet.description': '¡Hora de ponerse las botas!',
