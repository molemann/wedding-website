...
const translations: Translations = {
  en: {
    ...
    'rsvp.details.later': 'We\'ll send you more details about the celebration soon.',
  ...
  es: {
    ...
    'rsvp.details.later': 'Te enviaremos más detalles sobre la celebración pronto.',
    'rsvp.miss.you': '¡Te extrañaremos!',
